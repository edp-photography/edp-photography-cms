...
export interface ApiFashionPageFashionPage extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Fashion Page';
    pluralName: 'fashion-pages';
    singularName: 'fashion-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    googleMapsUrl: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiVideoclipsPageVideoclipsPage
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    youtubeGallery: Schema.Attribute.Component<'blocks.youtube-gallery', false>;
  };
}
